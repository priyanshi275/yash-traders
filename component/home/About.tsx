        ...
        <div className="grid lg:grid-cols-5 gap-10 lg:gap-16">
          ...
          <Reveal>
            <div className="lg:col-span-3">
              ...
              <p className="mt-6 md:mt-8 max-w-2xl text-base md:text-lg leading-7 md:leading-8 text-zinc-600">
              ...
              <p className="mt-4 max-w-2xl text-base md:text-lg leading-7 md:leading-8 text-zinc-600">
              ...
              <div className="mt-8 md:mt-10 grid grid-cols-2 gap-x-6 gap-y-3 md:gap-y-4 max-w-xl border-t border-zinc-200 pt-6 md:pt-8">
          ...
          <Reveal delay={0.15}>
            <div className="lg:col-span-2 lg:pl-10 lg:border-l lg:border-zinc-200">
